<!DOCTYPE html>
<html b:css='false' lang="fr">

<head>
<meta name="description" content="Chic dressing une boutique de vêtements et d'accessoires de marques de luxe avec des prix cassés, pièces de créateurs unique, et une achat-vente de seconde main.">
<title>Chic dressing marques de luxe</title>
</head>
<?php
...
if ( is_home() ) {
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">La FashionMap avec des prix cassés</h2>
		<iframe src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" title= "la position de chic dressing" width="100%" height="480" ></iframe>
